...
model = dict(type='ResNet', depth=50, num_classes=1000, maxpool=True, zero_init_residual=True)
...
log_interval = 20
save_interval = 10
work_dir = '/home/ljh/self-detection/ContrastiveCrop/checkpoints/small/underwater/simsiam_ccrop_pretrain'  # rewritten by args
resume = None
# resume = '/home/ljh/self-detection/ContrastiveCrop/checkpoints/small/underwater/simsiam_ccrop_pretrain/epoch_50.pth'
load = None
port = 10002
