...
model = dict(type='ResNet', depth=50, num_classes=dim, maxpool=True, zero_init_residual=True)
...
root = '/home/ljh/self-detection/data/UNDERWATER/4w_underwater'
...
log_interval = 20
save_interval = 10
work_dir = '/home/ljh/self-detection/ContrastiveCrop/checkpoints/small/underwater/simsiam_ccrop_4'  # rewritten by args
# resume = None
resume = '/home/ljh/self-detection/ContrastiveCrop/checkpoints/small/underwater/simsiam_ccrop_4/epoch_270.pth'
load = None
port = 10002
